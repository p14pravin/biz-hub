...
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container d-flex flex-column p-0">
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>Business</span></div>
                </a>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
			...
			<?php $query_url = mysqli_query($conn,"SELECT * from gallery where biz_id IN (SELECT biz_id from business where user_id = '$user_id')");

				$row_url = mysqli_fetch_array($query_url);
				
				$url = $row_url['biz_id'];
			?>
            <div class="container-fluid">
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
					<h6 class="text-dark mb-0"><a href="<?php echo "http://ndroid.tech?shop="; echo $url;?>"><?php echo "Your Business URL : http://ndroid.tech?shop="; echo $url;?></h6>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-primary py-2">
                            <div class="card-body">
								...
								<a href="whatsapp://send?text=<?php echo "I just created my business website using ndroid technology platform, to grow my business.";?>%0A%0A<?php echo "Please visit to my website. http://ndroid.tech?shop="; echo $url;?>%0A%0A<?php echo "*Build free your business website. and get your business online just in 5 min. Join our Platform.*"?>%0A%0A<?php echo "Sign UP http://ndroid.tech/signup/register";?>%0A%0A<?php echo "Thank You : ";?>https%3A%2F%2Fndroid.tech">
									<div class="row align-items-center no-gutters">
										<div class="col mr-2">
											<div class="text-uppercase text-primary font-weight-bold text-xs mb-1"><span class="text-danger">Share on</span></div>
											<div class="text-dark font-weight-bold h5 mb-0"><span class="text-success">WhatsApp</span></div>
										</div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-success py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-muted font-weight-bold text-xs mb-1"><span class="text-danger">SHARE ON</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span class="text-primary">FaceBook</span></div>
                                    </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-info py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-info font-weight-bold text-xs mb-1"><span class="text-danger">SHARE&nbsp; ON</span></div>
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-auto">
                                                <div class="text-dark font-weight-bold h5 mb-0 mr-3"><span class="text-info">Twitter</span></div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-warning py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-warning font-weight-bold text-xs mb-1"><span>Add Owner</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span class="text-warning">New</span></div>
                                    </div>
