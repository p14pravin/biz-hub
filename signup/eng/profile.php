...
<body id="page-top">
    <div id="wrapper">
                    ...
                    <div class="col">
                        <div class="card shadow mb-3">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 font-weight-bold">Business Settings</p>
                            </div>
                            <div class="card-body">
                                <!------------------business profile details------------------->
								<?php include('biz_profile_details.php');?>
								<!------------------business profile details------------------->
							</div>
						</div>
                ...
                <div class="container" style="padding: 0px;">
                    <div class="row">
                        <div class="col">
							...
							<?php include('biz_address.php');?>
                            <!------------------business Address profile------------------->
							
                        </div>
                        <div class="col-md-6">
                            
							<?php include('biz_contact.php');?>
                ...
                <div class="container" style="padding: 0px;">
                    <div class="row">
                        <div class="col">
							...
							<?php include('biz_owner.php');?>
							
                        <div class="card shadow"></div>
                    </div>
                    <div class="col">
                        
						<?php include('biz_images.php');?>						
        ...
        <div class="card shadow mb-5">
            <div class="card-header py-3">
                <p class="text-primary m-0 font-weight-bold">Submit Query</p>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <form>
                            <div class="form-group"><label for="signature"><strong>Problem / Query</strong><br></label><textarea class="form-control" rows="4" name="signature" required=""></textarea></div>
