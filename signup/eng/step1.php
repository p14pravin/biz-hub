                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="operation/step1.php">
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="username"><strong>Business</strong></label>
                                                    ...
                                                    <div class="form-group"><label for="last_name"><strong>Business Type</strong><br></label>
														<select class="form-control" name="type" onchange="getCategory(this.value);" required="">
															<optgroup label="This is a Types of Business">
																<option selected value="">Select type of Business</option>
																<?php 
