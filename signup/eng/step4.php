                                        ...
                                        <form method="POST" action="operation/step4.php" enctype="multipart/form-data">
                                            <div class="form-row">
                                                <div class="col">
                                                    ...
                                                    <div class="form-group" style="margin-top:30px"><label for="username"><strong>Name</strong><br></label><input class="form-control" type="text" placeholder="Owner Name" name="name" required=""></div>
													...
													<div class="form-group"><label for="username"><strong>Owner Image</strong><br></label>
                                                        <div class="form-row">
                                                            <div class="col text-center">
                                                ...
                                                <div class="col">
                                                    <section>
                                                        <div class="container" style="padding-right: 0px;padding-left: 0px;">
                                                            <div class="form-row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group"><label for="first_name"><strong>Mobile</strong><br></label><input class="form-control" type="number" placeholder="Mobile" name="mobile" required="" minlength="10" maxlength="10"></div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group"><label for="first_name"><strong>E-mail</strong><br></label><input class="form-control" type="email" placeholder="E-mail" name="email" required=""></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </section>
