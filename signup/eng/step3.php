                                ...
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="operation/step3.php">
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="username"><strong>Building / Street&nbsp;</strong><br></label><input class="form-control" type="text" placeholder="Name" name="street" required=""></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    ...
                                                    <section>
                                                        <div class="container" style="padding-right: 0px;padding-left: 0px;">
                                                            <div class="form-row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group"><label for="last_name"><strong>Village / Town</strong><br></label><input class="form-control" type="text" name="village" placeholder="Name" required=""></div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group"><label for="first_name"><strong>Pin Code</strong><br></label>
											...
											<button class="btn btn-primary btn-sm" type="submit">Save&nbsp;Settings</button></div>
                                        </form>
                                </div>
