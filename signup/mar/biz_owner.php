		...
		<form method="POST" action="operation/biz_owner.php" enctype="multipart/form-data">
			<div class="form-row">
				<div class="col">
					...
					<label for="username"><strong>मालकांची प्रतिमा</strong><br></label>
				...
				<div class="col">
					<section>
						<div class="container" style="padding-right: 0px;padding-left: 0px;">
							<div class="form-row">
								<div class="col-md-6">
									<div class="form-group"><label for="first_name"><strong>दुरध्वनी</strong><br></label><input value="<?php echo $row_owner['mobile']?>" class="form-control" type="tel" placeholder="Mobile" name="mobile" required="" minlength="10" maxlength="10"></div>
								</div>
								<div class="col-md-6">
									<div class="form-group"><label for="first_name"><strong>ई-मेल</strong><br></label><input value="<?php echo $row_owner['email']?>" class="form-control" type="email" placeholder="E-mail" name="email" required=""></div>
								</div>
							</div>
						</div>
					</section>
			...
			<div class="row">
				<div class="col text-center" style="margin: 10px;"><button class="btn btn-primary btn-sm" type="submit">राखून ठेवा&nbsp;स्थापन</button></div>
			</div>
		</form>
	</div>
</div>
