...
<form method = "POST" action="operation/biz_profile_details.php">
	<div class="form-row">
		<div class="col">
			<div class="form-group"><label for="username"><strong>व्यवसाय</strong></label><input class="form-control" type="text" placeholder="Business Name" name="name" value="<?php echo $row['biz_name']?>" required="" minlength="1" maxlength="50"></div>
		</div>
	</div>
	<div class="form-row">
		<div class="col">
			...
			<div class="form-group"><label for="last_name"><strong>व्यवसाय प्रकार</strong><br></label>
				...
				<select class="form-control" name="type" value="<?php echo $type_row[$language]?>" onchange="getCategory(this.value);" required="">
						...
						<option selected value="">व्यवसाय प्रकार निवडा</option>
						<?php 
