...
<head>
    ...
    <title>पासवर्ड विसरला - व्यवसाय</title>
								...
								<div class="col-lg-7">
									<div class="p-5">
										...
										<div class="text-center">
											<h4 class="text-dark mb-4">पासवर्ड बदला!</h4>
										</div>
										<form class="user" method="POST" action="">
											...
											<button disabled="" id = "forgot-btn" class="btn btn-primary btn-block text-white btn-user" type="submit">पासवर्ड बदला</button>
											<hr />
											<hr />
											<button class="btn btn-danger btn-block text-white btn-user" id="sign-out">मोबाइल नंबर बदला</button>
										</form>
										<div class="text-center"><a class="small" href="register.php">नवीन खाते तयार करा.</a></div>
