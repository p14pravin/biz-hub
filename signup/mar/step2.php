        ...
        <div class="container"><a class="navbar-brand" href="#">NDROID.TECH</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">नेव्हिगेशन टॉगल करा</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="#"></a>होम</li>
            ...
            <div class="col-lg-8">
                ...
                <div class="row">
                    <div class="col">
							...
							<div class="wrapper">
							  <div class="drop">
								<div class="cont">
								  ...
								  <div class="browse">
									ब्राउझ करण्यासाठी येथे क्लिक करा
								  </div>
								</div>
                        ...
                        <div class="row">
                            <div class="col text-center"><button class="btn btn-primary btn-sm text-center" type="submit" style="margin-top: 50px;">अद्यतनित स्थापन  करा</button></div>
                        </div>
                    </div>
                </div>
				</form>
