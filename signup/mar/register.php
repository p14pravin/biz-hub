...
<body class="bg-gradient-primary">
    ...
    <div id="loading">लोड करीत आहे ...</div>
								...
								<div class="col-lg-7">
									<div class="p-5">
										...
										<div class="text-center">
											<h4 class="text-dark mb-4">खाते तयार करा!</h4>
										</div>
										<form class="user" method="POST" action="">
											...
											<div class="form-group">
												<div class="custom-control custom-checkbox small">
													<div class="form-check"><input class="form-check-input custom-control-input" type="checkbox" id="formCheck-1" required=""><label class="form-check-label custom-control-label" for="formCheck-1">अटी व शर्ती लागू</label></div>
												</div>
											</div>
											<button disabled="" id="register" class="btn btn-primary btn-block text-white btn-user" type="submit">खाते नोंदणी करा</button>
											<hr />
											<hr />
											<button class="btn btn-danger btn-block text-white btn-user" id="sign-out">मोबाइल नंबर बदला</button>
										</form>
										<div class="text-center"><a class="small" href="forgot-password.php">पासवर्ड विसरलात ?</a></div>
										<div class="text-center"><a class="small" href="login.php">आधीपासूनच एक खाते आहे?   लॉगिन!</a></div>
