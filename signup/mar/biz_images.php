...
<div class="card shadow mb-3">
	<div class="card-header py-3">
		<p class="text-primary m-0 font-weight-bold">व्यवसाय चित्र गॅलरी</p>
	</div>
	<div class="card-body">
		<form method="POST" action="operation/biz_images.php" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col text-center" style="margin: 10px;"><button class="btn btn-primary btn-sm" value="image1" name="img" type="submit">अद्यतन स्थापन</button></div>
			</div>
		</form>
	...
	<div class="card-body">
		<form method="POST" action="operation/biz_images.php" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col text-center" style="margin: 10px;"><button class="btn btn-primary btn-sm" value="image2" name="img" type="submit"> अद्यतनित स्थापन  करा </button></div>
			</div>
		</form>
	...
	<div class="card-body">
		<form method="POST" action="operation/biz_images.php" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col text-center" style="margin: 10px;"><button class="btn btn-primary btn-sm" value="image3" name="img" type="submit">अद्यतन स्थापन</button></div>
			</div>
		</form>
	...
	<div class="card-body">
		<form method="POST" action="operation/biz_images.php" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col text-center" style="margin: 10px;"><button class="btn btn-primary btn-sm" value="image4" name="img" type="submit">अद्यतन स्थापन</button></div>
			</div>
		</form>
	...
	<div class="card-body">
		<form method="POST" action="operation/biz_images.php" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col text-center" style="margin: 10px;"><button class="btn btn-primary btn-sm" value="image5" name="img" type="submit">अद्यतन स्थापन</button></div>
			</div>
		</form>
